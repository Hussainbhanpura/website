...
import Bose from "../assests/Bose-logo_150x150.png";
import Canon from "../assests/Canon-logo_150x150.jpg";
import Dyson from "../assests/dyson_150x150.jpeg";
import Hp from "../assests/hp_log_150x150.png";
import Sony from "../assests/sony-150x150.jpg";
  ...
  return (
    <div className='container' style={{ marginTop: "15vh" }}>
      <h2 className='brand-carousel-title'>
        Trusted Partners to Global Brands
      </h2>
      ...
      <div className='brand-carousel'>
        <Slider ref={sliderRef} {...settings}>
          ...
          <img src={Bose} alt='bose' className='brand-image' />
          <img src={Canon} alt='canon' className='brand-image' />
          <img src={Dyson} alt='dyson' className='brand-image' />
          <img src={Hp} alt='hp' className='brand-image' />
          <img src={Sony} alt='sony' className='brand-image' />
        </Slider>
